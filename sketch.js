...
function setup() {
	...
	leftSide = createSprite(350, height-90, 20, 100);
	leftSide.shapeColor = "red";

	rightSide = createSprite(450, height-90, 20, 100);
	rightSide.shapeColor = "red";

	bottomSide = createSprite(400, height-50, 100, 20)
...
function draw() {
  ...
  console.log("BODY : " + packageSprite.y)
